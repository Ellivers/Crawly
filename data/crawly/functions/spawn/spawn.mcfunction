...
execute at @s run summon minecraft:interaction ~ ~ ~ {Tags:["crawly.prevent_interaction","crawly.tick","crawly","smithed.strict"],width:1f,height:1.8f,Passengers:[{id:"minecraft:area_effect_cloud",Age:0,Duration:12,WaitTime:0}]}
