...
execute if entity @s[distance=...72] as @e[type=minecraft:area_effect_cloud,tag=crawly.crawl_player] if score @s crawly.id = #ID_temp crawly run function crawly:entity/remove
