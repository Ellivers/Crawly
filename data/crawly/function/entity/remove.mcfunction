...
execute as @e[type=minecraft:interaction,tag=crawly.prevent_interaction] if score @s crawly.id = #ID_temp crawly run function crawly:entity/remove_interaction
