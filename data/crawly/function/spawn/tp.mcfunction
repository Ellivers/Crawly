...
execute if score #align crawly matches 0 align y run tp ^ ^-.2 ^
execute if score #align crawly matches 1 align y run tp ^-.3 ^-.2 ^
execute if score #align crawly matches 2 align y run tp ^.3 ^-.2 ^
